      ...
      <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden border border-slate-800">
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <div className={`w-2 h-2 rounded-full animate-pulse ${isStandalone ? 'bg-emerald-500' : 'bg-orange-500'}`} />
                <span className={`text-[10px] font-black uppercase tracking-[0.2em] ${isStandalone ? 'text-emerald-500' : 'text-orange-500'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className={`p-5 rounded-2xl border transition-all ${isStandalone ? 'bg-emerald-500/10 border-emerald-500/30' : 'bg-slate-800 border-slate-700 animate-pulse'}`}>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center">
